  ...
  return (
    <div className="mx-auto max-w-4xl px-4 pb-20 pt-16 md:px-6 md:pt-20">
      ...
      <div className="mt-8 rounded-[28px] border border-white/10 bg-[#151B34]/80 p-8 md:p-10">
        <div className="text-xs uppercase tracking-[0.2em] text-[#6EA8FE]">Education</div>
        <h1 className="mt-3 text-3xl font-semibold text-[#E6EAF2]">教育背景</h1>

        <div className="mt-8">
          <div className="text-2xl font-semibold text-[#E6EAF2]">{education.school}</div>
          <div className="mt-2 text-base text-[#B8C1D0]">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            {education.details.map((d) => (
              <span
                key={d}
                className="rounded-full border border-white/10 bg-white/5 px-5 py-2 text-sm text-[#BFC8D6]"
              >
                {d}
              </span>
            ))}
        ...
        <div className="mt-10 grid gap-5 md:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
            <div className="text-sm font-medium text-[#6EA8FE]">专业方向</div>
            <p className="mt-2 text-sm leading-7 text-[#B8C1D0]">
              电子信息工程专业背景，具备信号处理、数据分析基础能力，为AI训练中的数据工程和模型评测工作提供了扎实的理工科基础。
            </p>
          </div>
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
            <div className="text-sm font-medium text-[#6EA8FE]">学业表现</div>
            <p className="mt-2 text-sm leading-7 text-[#B8C1D0]">
